...
require (
	...
	github.com/akitasoftware/akita-ir v0.0.0-20241212105914-68c47ec34a0a // todo: update this to match the commit on master once observability-ir#16 is merged
