...
var ProtobufFileHashes map[string][]byte = map[string][]byte{"method.proto": []byte{108, 49, 80, 113, 109, 57, 41, 0}, "witness.proto": []byte{42, 213, 185, 25, 124, 226, 76, 187}, "types.proto": []byte{98, 84, 34, 180, 249, 140, 214, 227}, "spec.proto": []byte{13, 101, 129, 126, 232, 252, 1, 146}}
